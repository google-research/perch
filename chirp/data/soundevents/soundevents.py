...
class Soundevents(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    logging.info('Currently considering a total of %s soundevent.',
  ...
  def _load_dataset(self, dl_manager: tfds.download.DownloadManager,
    ...
    paths = dl_manager.download_and_extract({
        'dataset_info_dev':
            (self.DATASET_CONFIG['dev']['ground_truth_file']).as_posix(),
        'dataset_info_eval':
            (self.DATASET_CONFIG['eval']['ground_truth_file']).as_posix(),
    })
