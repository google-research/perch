...
def get_config() -> config_dict.ConfigDict:
  ...
  # small network, for use with the small dataset (used with 1 conformer block).
  # see the hubert_larger.py config for a larger architecture.
  ...
  # Configure HuBERT.
  model_config.final_dim = 512
  model_config.logit_temp = 0.1
  model_config.alpha = 1.0
  model_config.quant_loss_mult = 100
  ...
  num_quantizer_pretrain_steps = config_dict.FieldReference(1_000)
